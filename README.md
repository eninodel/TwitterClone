...
1. Discuss the different ways to present a details view and their tradeoffs (modal, push, etc.)
2. Best area to do the timeSinceCreated string compution. Should it be done in the tweet model or each individual tweetTableViewCell?

## Video Walkthrough

Here's a walkthrough of implemented user stories:

![Alt Text](https://user-images.githubusercontent.com/71790814/175626446-09c65961-aa7a-4bad-9fdd-65fca7548979.gif)
...
- [DateTools] (https://github.com/MatthewYork/DateTools) - tools for dates
